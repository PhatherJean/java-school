...
public class RestExceptionHandler extends ResponseEntityExceptionHandler
{
            ...
            WebRequest request)
    {
        ...
        errorDetail.setDeveloperMessage("HTTP Method Not Valid for Endpoint( Check for valid URI an Proper HTTP Method");
        errorDetail.setErrors(helperFunctions.getConstraintViolation(ex));
            ...
            WebRequest request)
    {
        ...
        errorDetail.setDetail("Path: " + request.getDescription(false) + " | Suppoerted Content / Media Types are:" + ex.getSupportedMediaTypes());
            ...
            WebRequest request)
    {
        ...
        errorDetail.setDetail("path: " + request.getDescription(false));
